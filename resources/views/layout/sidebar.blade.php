<ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
    ...
    {{-- <hr class="sidebar-divider my-0">
    <li class="nav-item active">
        <a class="nav-link" href="/data-angkutan">
            <i class="fas fa-fw fa-tachometer-alt"></i>
            <span>Data Angkutan</span></a>
    </li> --}}
    ...
    {{-- <li class="nav-item">
        ...
        <div id="collapsePages" class="collapse" aria-labelledby="headingPages" data-parent="#accordionSidebar">
            <div class="bg-white py-2 collapse-inner rounded">
                ...
                <a class="collapse-item" href="/data-driver">Driver</a>
                <a class="collapse-item" href="/data-profile">Petugas</a>
                <a class="collapse-item" href="/data-profile">Admin</a>
                <a class="collapse-item" href="/data-profile">Super Admin</a>
                
            </div>
        </div>
    </li> --}}
    {{-- <li class="nav-item active">
        <a class="nav-link" href="/data-driver">
            <i class="fas fa-fw fa-tachometer-alt"></i>
    ...
    {{-- <hr class="sidebar-divider my-0">
    <li class="nav-item active">
        <a class="nav-link" href="/data-penumpang">
            <i class="fas fa-fw fa-tachometer-alt"></i>
    ...
    <li class="nav-item">
        <a class="nav-link collapsed" href="#" data-toggle="collapse" data-target="#collapsePagesData"
            aria-expanded="true" aria-controls="collapsePagesData">
            <i class="fas fa-fw fa-folder"></i>
            <span>Data</span>
        </a>
